                ...
                <div className="col-lg-8 offset-lg-2 order-1 order-md-2">
                    <div className="atf-education-content">
                        <nav>
                            ...
                            >
                                <a
                                    className={`nav-item nav-link ${activeTab === 'nav-interview' ? 'active' : ''}`}
                                    id="nav-interview-tab"
                                    onClick={() => handleTabClick('nav-interview')}
                                    data-bs-toggle="tab"
                                    // href="#nav-interview"
                                    role="tab"
                                    aria-selected="false"
                                ...
                                <a
                                    className={`nav-item nav-link ${activeTab === 'nav-about' ? 'active' : ''}`}
                                    id="nav-about-tab"
                                ...
                                <a
                                    className={`nav-item nav-link ${activeTab === 'nav-award' ? 'active' : ''}`}
                                    id="nav-award-tab"
                        ...
                        >
                            <div
                                className={`tab-pane fade ${activeTab === 'nav-interview' ? 'show active' : ''} `}
                                id="nav-interview"
                                role="tabpanel"
                            ...
                            <div
                                className={`tab-pane fade ${activeTab === 'nav-about' ? 'show active' : ''} `}
                                id="nav-about"
                                role="tabpanel"
                            ...
                            <div
                                className={`tab-pane fade ${activeTab === 'nav-award' ? 'show active' : ''} `}
                                id="nav-award"
                                role="tabpanel"
